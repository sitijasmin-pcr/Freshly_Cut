...
export default function Produk() {
  ...
  const group = (cat) =>
    filteredProducts.filter((p) => p.kategori === cat);
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {list.map((prod) => (
        ...
        >
          ...
          <div className="p-4">
            <h3 className="font-black text-[#004d33]">
              {prod.nama}
            </h3>
            ...
            <div className="flex justify-between mt-3">
              <button
                ...
                className="p-2 bg-gray-100 rounded-xl hover:bg-[#004d33] hover:text-white"
              >
                <Edit size={16} />
              </button>
              ...
              <button
                onClick={() => handleDelete(prod.id, prod.nama)}
                className="p-2 bg-red-50 text-red-600 rounded-xl hover:bg-red-500 hover:text-white"
              >
                <Trash2 size={16} />
              </button>
            </div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-end mb-6">
          <button
            ...
            className="bg-[#004d33] text-white px-6 py-3 rounded-2xl font-black hover:opacity-90 flex items-center gap-2"
          >
            <Plus size={18} /> Tambah Produk
          </button>
        </div>
        ...
        {!loading && (
          <>
            {group("Buah Potong 250gr").length > 0 && (
              <div className="mb-10">
                <h2 className="font-black text-lg mb-4">
                  Buah Potong 250gr
                </h2>
                {renderCards(group("Buah Potong 250gr"))}
              </div>
            )}

            {group("Buah Potong 500gr").length > 0 && (
              <div className="mb-10">
                <h2 className="font-black text-lg mb-4">
                  Buah Potong 500gr
                </h2>
                {renderCards(group("Buah Potong 500gr"))}
              </div>
            )}

            {group("Dessert").length > 0 && (
              <div>
                <h2 className="font-black text-lg text-orange-500 mb-4">
                  Dessert
                </h2>
                {renderCards(group("Dessert"))}
              </div>
            )}
          </>
        )}
