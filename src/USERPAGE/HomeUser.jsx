...
export default function HomeUser() {
  ...
  <div className="flex items-center space-x-2">
    <img src="/img/Logo.png" alt="Tomoro Coffee" className="h-10" />
  ...
  <nav className="hidden md:flex space-x-8 text-sm text-gray-700 font-medium">
    ...
    <a href="#location" className="hover:text-orange-500">
      Location
    </a>
  </nav>
  <button className="bg-orange-500 text-white px-4 py-2 rounded-full text-sm font-semibold shadow hover:bg-orange-600">
    DOWNLOAD APP
  </button>
</header>
