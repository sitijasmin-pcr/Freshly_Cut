...
//   },
//   {
//     question: "Apa saja jam operasional Tomoro Coffee?",
//     answer:
//       "Jam operasional kami bervariasi tergantung lokasi outlet. Silakan cek halaman lokasi kami untuk detail lebih lanjut.",
//   },
//   {
//     question: "Apakah Tomoro Coffee memiliki program loyalitas?",
//     answer:
//       "Ya, kami memiliki program loyalitas di mana Anda bisa mengumpulkan poin setiap pembelian dan menukarkannya dengan rewards menarik.",
//   },
//   {
//     question: "Bagaimana cara mengajukan feedback atau keluhan?",
//     answer:
//       "Anda bisa mengirimkan feedback atau keluhan melalui formulir di halaman 'Feedback' kami atau menghubungi layanan pelanggan kami.",
//   },
// ];
...
//         <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden"> {/* Added overflow-hidden */}
//           {icons.map((icon) => (
//             <div
//               key={icon.id}
...
//       {/* Floating animation styles - Pastikan ini di dalam komponen React, bukan global <style jsx> */}
//       <style>{`
//         @keyframes float {
//           0% {
