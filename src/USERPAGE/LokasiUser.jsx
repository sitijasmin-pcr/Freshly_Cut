...
//       imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTI5NcWqM9uATtDC03KzZBKOhidfC2S11Rgmg&s",
//     },
//   ]);
    ...
    <div className="font-sans bg-[#FDFBE2] min-h-screen">
        ...
        <nav className="bg-[#2D5A27] rounded-full max-w-4xl mx-auto py-3 px-8 flex justify-between items-center text-white shadow-lg">
          ...
          <div className="flex gap-6 text-sm font-medium">
            ...
            <Link to="/lokasi" className="text-yellow-400 font-bold">
              Lokasi
            </Link>
      ...
      <section className="py-16 px-6 text-center">
        <h1 className="text-5xl font-serif font-bold text-[#2D5A27] mb-6">Lokasi Kami</h1>
        <p className="text-gray-600 max-w-xl mx-auto">Temukan outlet Freshly Cut terdekat di lingkungan kampus PCR dan sekitarnya.</p>
      </section>
      ...
      <main className="max-w-4xl mx-auto px-6 pb-20">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col md:flex-row gap-8 items-center"
        >
          <div className="w-full md:w-1/2 h-64 bg-gray-100 rounded-2xl flex items-center justify-center text-gray-400">
            [Peta Lokasi]
          </div>
          <div className="w-full md:w-1/2 space-y-4">
            <h2 className="text-2xl font-bold text-[#2D5A27]">Freshly Cut - PCR</h2>
            <p className="text-gray-600 flex items-start gap-2">
              <MapPin className="text-[#A3C982] shrink-0" />
              Jl. Umban Sari, Rumbai, Pekanbaru (Area Lingkungan Politeknik Caltex Riau)
            </p>
            <p className="text-gray-600 flex items-center gap-2">
              <Clock className="text-[#A3C982]" />
              Senin - Jumat: 08.00 - 16.00
            </p>
            <a 
              href="#" 
              className="inline-block mt-4 bg-[#F3B414] text-[#2D5A27] px-6 py-2 rounded-full font-bold hover:bg-yellow-500 transition"
            >
              Buka di Google Maps
            </a>
          </div>
