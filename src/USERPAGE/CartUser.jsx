        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          <Link to="/HomeUser" className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              <span className="text-xl font-black text-blue-900 block leading-none">TOMORO</span>
          ...
          <nav className="hidden md:flex gap-10">
            {['Home', 'Menu', 'Story', 'FAQ', 'Feedback'].map((item) => (
              <Link key={item} to={`/${item}User`} className="text-sm font-bold uppercase tracking-widest text-gray-500 hover:text-blue-600 transition-all">
                {item}
              </Link>
            ))}
          </nav>
          ...
          <div className="flex items-center gap-5">
            <Link to="/ProfileUser" className="p-2 hover:bg-gray-50 rounded-full transition-colors"><UserCircle size={22} /></Link>
            <Link to="/CartUser" className="p-2 bg-gray-100 rounded-full transition-colors text-blue-600"><ShoppingCart size={22} /></Link>
          </div>
        </div>
      </header>
